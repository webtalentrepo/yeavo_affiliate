    ...
    public function getTransactionList($merchantList = null, DateTime $dStartDate = null, DateTime $dEndDate = null)
    {
        ...
        try {
            ...
            while ($loop) {
                ...
                $params = [
                    new Parameter('reportCurrencyCode', $currency),
                    new Parameter('fromDate', $dStartDate->format("Ymd")),
                    new Parameter('toDate', $dEndDate->format("Ymd")),
                ...
                foreach ($transactionsList['items'] as $transactionJson) {
                    ...
                    $transaction['amount'] = Utilities::parseDouble($transactionJson['orderValue']);
                    $transaction['commission'] = Utilities::parseDouble($transactionJson['commission']);
