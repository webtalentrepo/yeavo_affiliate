 ...
 **/
class EasyMarketing extends Network
{
    ...
    public function getTransactionList($merchantList = null, DateTime $dStartDate = null, DateTime $dEndDate = null)
    {
        ...
        try {
            ...
            foreach ($a_dates as $dates) {
                ...
                $params = [
                    new Parameter('condition[period][from]', $dStartDate->format('d.m.Y')),
                    new Parameter('condition[period][to]', $dEndDate->format('d.m.Y')),
                ];
    ...
    public function createTransactionArray($transactionJson)
    {
        ...
        $transaction['commission'] = Utilities::parseDouble($transactionJson['provision']);
        //subid
