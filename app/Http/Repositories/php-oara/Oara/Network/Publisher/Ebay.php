...
class Ebay extends Network
{
    ...
    public function getTransactionList($merchantList = null, DateTime $dStartDate = null, DateTime $dEndDate = null)
    {
        ...
        $params = [
            new Parameter('CHECKOUT_SITE', !empty($this->_sitesAllowed) ? implode(',', $this->_sitesAllowed) : '0'), //0 to return all OR Define 1 value from accepted values Accepted Values: US, UK, CA, DE, IT, FR, AU, AT, BE, CH, NL, ES, IE
            new Parameter('STATUS', 'ALL'), //Approved, Pending, OR All
            new Parameter('START_DATE', $dStartDate->format('Y-m-d')), //YYYY-MM-DD
            new Parameter('END_DATE', $dEndDate->format('Y-m-d')), //YYYY-MM-DD
        ];
