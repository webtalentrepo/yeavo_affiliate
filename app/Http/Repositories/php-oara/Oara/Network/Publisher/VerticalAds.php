 ...
 **/
class VerticalAds extends Network
{
    ...
    public function getTransactionList($merchantList = null, DateTime $dStartDate = null, DateTime $dEndDate = null)
    {
        ...
        try {
            ...
            foreach ($a_dates as $dates) {
                ...
                $params = [
                    new Parameter('network', $id_site),
                    new Parameter('user', $user),
                    new Parameter('key', $password),
                    new Parameter('startDateConversion', $dStartDate->format('Y-m-d')),
                    new Parameter('endDateConversion', $dEndDate->format('Y-m-d')),
                ];
    ...
    public function createTransactionArray($transactionJson)
    {
        ...
        $transaction['amount'] = Utilities::parseDouble($transactionJson['turnover']);
