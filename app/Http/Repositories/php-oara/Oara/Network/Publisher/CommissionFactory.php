 ...
 *
 */
class CommissionFactory extends Network
{
    ...
    public function getTransactionList($merchantList = null, DateTime $dStartDate = null, DateTime $dEndDate = null)
    {
        ...
        foreach ($transactionsExportList as $transaction) {
            if (isset($merchantIdList[$transaction ["MerchantId"]])) {
                ...
                $obj ['amount'] = Utilities::parseDouble($transaction ["SaleValue"]);
                $obj ['commission'] = Utilities::parseDouble($transaction ["Commission"]);
                $transactions [] = $obj;
            }
        }
